...
import { LeftSidebarInspector } from './LeftSidebar/sidebar-inspector';
import {
...
class Editor extends React.Component {
  constructor(props) {
    ...
    const appId = "ABCDEFGH";

    const currentUser = {
      email: "kkarda77@gmail.com",
      first_name: "Kapil",
      last_name: "Karda"
    };
    let userVars = {};
            ...
            <header className="navbar navbar-expand-md navbar-light d-print-none">
              <div className="container-xl header-container">
                ...
                <h1 className="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0">
                  <Link to={'/'}>
                    <img src="/assets/images/logo.png" width="110" height="32" className="navbar-brand-image" />
                  </Link>
                </h1>
                {/* {this.state.app && (
                  <input
                ...
                <div className="navbar-nav flex-row order-md-last">
                  ...
                  <div className="nav-item dropdown  d-md-flex me-2">
                    {/* <a
                      href={appLink}
                      target="_blank"
                    ...
                    >
                     ...
                     <LeftSidebarInspector darkMode={this.props.darkMode} globals={this.props.globals} components={this.props.components} queries={this.props.queries} />
                  </div>
